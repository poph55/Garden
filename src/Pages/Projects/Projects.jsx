      ...
      <section className="project-list" aria-label="Projects">
        <article className="project-row">
          ...
          <Link className="project-preview subway-preview" to="/projects/subway-live" aria-label="Open Subway Live" {...preloadOnIntent('subway-live')}>
            <div className="subway-preview-grid"><i className="sp-line sp-red"/><i className="sp-line sp-blue"/><i className="sp-line sp-green"/><i className="sp-line sp-yellow"/><b className="sp-train sp-one">A</b><b className="sp-train sp-two">6</b><b className="sp-train sp-three">N</b><span>LIVE · NEW YORK</span></div>
          </Link>
        </article>
